...
<body>
            ...
            <div class="col-lg-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <a class="btn btn-primary" href="./blogPage/index.php">Read more →</a>
                    </div>
                </div>
    ...
    " onmouseover="this.style.backgroundColor='darkblue';" onmouseout="this.style.backgroundColor='blue';"><a
            href="./addBlog.php">+</a></button>
    <!-- Bootstrap core JS-->
