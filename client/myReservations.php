...
$response = $reservationObj->getReservationDetails($userID);
          ...
          <tbody class="text-gray-700">
            <?php foreach ($reservations as $reservation): ?>
              <tr class="border-t hover:bg-gray-50">
                <td class="py-4 px-6 font-medium text-gray-800"><?= htmlspecialchars($reservation['vehiclesName']) ?></td>
                ...
                <td class="py-4 px-6 font-bold text-teal-600"><?= htmlspecialchars($reservation['rent']) ?> MAD</td>
                <td class="py-4 px-6">
                ...
                <td class="py-4 px-6 capitalize"><?= htmlspecialchars($reservation['reservation_status']) ?></td>
                <td class="py-4 px-6">
                  <!-- Edit and Delete buttons -->
                  <a href="editReservation.php?id=<?= $reservation['reservationID'] ?>" class="text-blue-600 hover:text-blue-800">Edit</a> |
                  <a href="deleteReservation.php?id=<?= $reservation['reservationID'] ?>" class="text-red-600 hover:text-red-800" onclick="return confirm('Are you sure you want to delete this reservation?')">Delete</a>
                </td>
              </tr>
            <?php endforeach; ?>
          </tbody>
